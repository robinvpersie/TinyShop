...
//        if (i == 0) {
//            [self.titleBtnArr[i] setTitleColor:GreenColor forState:UIControlStateNormal];
//        }
...
//            [self changTintColorWithTintColor:GreenColor tintColorImgName:CFDrowMenuViewSrcName(@"绿箭头.png")?:CFDrowMenuViewFrameworkSrcName(@"绿箭头.png") ForButton:self.titleBtnArr[i]];
...
{
    if (!_bgView) {
        _bgView = [[UIView alloc] initWithFrame:CGRectMake(0, self.startY, CFScreenWidth*2, CFScreenHeight)];
