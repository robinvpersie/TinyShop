...
- (void)initialize{
    ...
    _backGround = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height-2)];
//    _backGround.image = [UIImage imageNamed:@"256252.jpg"];
    [superViewOfScrollView addSubview:_backGround];
