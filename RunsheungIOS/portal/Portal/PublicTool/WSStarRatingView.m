...
- (void)commonInit
{
    if (self.backgroundImageStr == nil){
        self.starBackgroundView = [self buidlStarViewWithImageName:kBACKGROUND_STAR];
    }else {
        self.starBackgroundView = [self buidlStarViewWithImageName:self.backgroundImageStr];
    }
    if (self.frontImageStr == nil){
         self.starForegroundView = [self buidlStarViewWithImageName:kFOREGROUND_STAR];
    }else {
        self.starForegroundView = [self buidlStarViewWithImageName:self.frontImageStr];
    }
