...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        _tableView = [[TPKeyboardAvoidingTableView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, SCREEN_HEIGHT) style:UITableViewStyleGrouped];//不用自定义style，需要设置背景
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (tableView == _pickTableView) {
        ...
        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, width, 20)];
