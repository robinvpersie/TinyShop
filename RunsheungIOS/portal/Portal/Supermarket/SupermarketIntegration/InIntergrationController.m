...
@interface InIntergrationController ()

@property(nonatomic, strong) NSMutableArray *pointsArr;

@end

@implementation InIntergrationController {
...
- (void)requestData {
    [KLHttpTool supermarketGetPointWithOption:2 pageIndex:_pageIndex success:^(id response) {
        NSLog(@"%@",response);
