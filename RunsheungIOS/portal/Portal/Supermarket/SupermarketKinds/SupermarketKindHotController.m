//
//  SupermarketKindHotController.m
//  Portal
//
...
@interface SupermarketKindHotController ()
...
@implementation SupermarketKindHotController {
//    UIImageView *noData;
//    UILabel *msg;
}
...
- (void)requestData {
    [KLHttpTool getSupermarketKindListWithKindCode:self.category_code level:self.level orderByType:1 sortField:@"hot" pageindex:_index pageSize:10 success:^(id response) {
        NSLog(@"%@",response);
