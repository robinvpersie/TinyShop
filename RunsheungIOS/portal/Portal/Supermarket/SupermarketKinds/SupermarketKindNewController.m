//
//  SupermarketKindNewController.m
//  Portal
//
...
@interface SupermarketKindNewController ()
...
@implementation SupermarketKindNewController
...
- (void)requestData {
    [KLHttpTool getSupermarketKindListWithKindCode:self.category_code level:self.level orderByType:1 sortField:@"public_date" pageindex:_index pageSize:10 success:^(id response) {
        NSLog(@"%@",response);
