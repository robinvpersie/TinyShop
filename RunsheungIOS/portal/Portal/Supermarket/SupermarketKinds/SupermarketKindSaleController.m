//
//  SupermarketKindSaleController.m
//  Portal
//
...
@interface SupermarketKindSaleController ()
...
@implementation SupermarketKindSaleController
...
- (void)requestData {
    [KLHttpTool getSupermarketKindListWithKindCode:self.category_code level:self.level orderByType:1 sortField:@"sold" pageindex:_index pageSize:10 success:^(id response) {
        NSLog(@"%@",response);
