//
//  HotelMidCommentViewController.m
//  Portal
//
...
@interface HotelMidCommentViewController ()
...
@implementation HotelMidCommentViewController
...
- (void)requestData {
    [YCHotelHttpTool hotelGetCommentListWithHotelID:self.hotelID optionIndex:3 pageIndex:0 success:^(id response) {
        NSLog(@"%@",response);
