...
- (void)createUI
{
    ...
    UIBarButtonItem *dismiss = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(dismissController)];
    self.navigationItem.leftBarButtonItem = dismiss;
    dismiss.tintColor = HotelGrayColor;
}
