//
//  HotelFinishedOrderController.m
//  Portal
//
...
@interface HotelFinishedOrderController ()
...
@implementation HotelFinishedOrderController
...
- (void)requestData {
    [YCHotelHttpTool hotelGetOrderListWithPageIndex:self.pageIndex orderStatus:5 success:^(id response) {
        NSLog(@"%@",response);
