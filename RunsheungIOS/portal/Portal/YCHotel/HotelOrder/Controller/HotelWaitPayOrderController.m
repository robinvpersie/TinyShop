...
@interface HotelWaitPayOrderController ()
...
@implementation HotelWaitPayOrderController
...
- (void)requestData {
    [YCHotelHttpTool hotelGetOrderListWithPageIndex:self.pageIndex orderStatus:0 success:^(id response) {
        NSLog(@"%@",response);
